...
var useCheatCodes = function (_a) {
    ...
    var _d = (0, react_1.useState)([]), activeCheats = _d[0], setActiveCheats = _d[1];
    var _e = (0, react_1.useState)([]), keystrokes = _e[0], setKeystrokes = _e[1];
    ...
    var getCheatCodeByName = (0, react_1.useCallback)(function (name) {
    ...
    (0, react_1.useEffect)(function () {
        ...
        for (var i = 0; i < cheatCodes.length; i += 1) {
            ...
            var isCheatValid = (0, utils_1.compareStringArrays)(code, __spreadArray([], keystrokes.slice(-(code === null || code === void 0 ? void 0 : code.length)), true));
            if (isCheatValid) {
